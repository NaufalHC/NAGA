...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        bg = new Background(BitmapFactory.decodeResource(getResources(), R.drawable.pak_akbar_bg));
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.nogo1), 133, 80, 12);
    ...
    public void updateTopBorder()
    {
        ...
        {
            topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(),R.drawable.bricc
            ...
            if(topborder.get(i).getX()<-20)
            {
                ...
                if(topDown)
                {
                    topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(),
                            R.drawable.bricc),topborder.get(topborder.size()-1).getX()+20,
    ...
    public void updateBottomBorder()
    {
        ...
        {
            botborder.add(new BotBorder(BitmapFactory.decodeResource(getResources(), R.drawable.spike),
